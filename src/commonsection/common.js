          ...
          <Link className="navbar-brand " to="/">
            <div className="row w-50">
              <div className="col-md-6">
                <img
                  src={logo}
                  alt="Sribhashyam Rithvik Portfolio Logo"
                  width="50px"
                  className="img-fluid"
                />
              </div>
            ...
            <div className="navbar-nav fw-bold">
              ...
              {/* {!isAdminAuthenticated() && (
                <a
                  ...
                  href="https://blog.tech.sribhashyamrithvik.in/"
                  target="_blank"
                  rel="noreferrer"
                >
                  Blog
...
const ConnectWithMe = () => (
  ...
  >
    <div className="social-media-container" rel="noreferrer">
      <a
        href="https://www.facebook.com/sribhashyam.rithvik/"
        target="_blank"
      ...
      <a
        href="https://www.instagram.com/sunnyrithvik/"
        target="_blank"
        className="social-media-container-item mb-5"
        rel="noreferrer"
      >
      ...
      <a
        href="https://in.linkedin.com/in/rithvik-sribhashyam"
        target="_blank"
        className="social-media-container-item mb-5"
        rel="noreferrer"
      >
      ...
      <a
        href="https://github.com/sunnyrithvik"
        target="_blank"
        className="social-media-container-item mb-5"
        rel="noreferrer"
      >
...
const socialMediaInformation = [
...

  {
    ...
    link: "https://www.github.com/sunnyrithvik",
    color: "#1d1a1a",
  },
  {
    icon: "fab fa-linkedin-in fa-2x",
    link: "https://www.linkedin.com/in/rithvik-sribhashyam/",
    color: "#2867B2",
  },

  {
    icon: "fab fa-facebook-f fa-2x",
    link: "https://www.facebook.com/sribhashyam.rithvik/",
    color: "#3b5998",
  },
  {
    icon: "fab fa-instagram fa-2x",
    link: "https://www.instagram.com/sunnyrithvik/",
    color: "#e4405f",
  },

  {
    icon: "fab fa-twitter fa-2x",
    link: "https://x.com/sunnyrithvik",
    color: "#1da1f2",
  },
];
      ...
      <div className="row">
        <div className="col-lg-8">
          ...
          <div className="copy fw-bold mt-5">
            ...
            <a href="https://sribhashyamrithvik.com/">Sribhashyam Rithvik</a>
          </div>
        </div>
      </div>
    </div>
